...
import os
#data source: Malicious URLs dataset (links: https://www.kaggle.com/datasets/sid321axn/malicious-urls-dataset)
...
def list_run(new_data):
    ...
    if ip_address and last_modified:
        ...
        df.to_csv('data2_clean.csv', mode='a', header=False, index=False)

def main():
    file_path = r'F:\data\Graduate_Design\project_8099\clean_data\clean_data2\data2.csv'
