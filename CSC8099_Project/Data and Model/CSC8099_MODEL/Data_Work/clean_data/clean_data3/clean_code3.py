...
import os
#data source: mendeley (link: https://data.mendeley.com/datasets/vfszbj9b36/1)
...
def list_run(new_data):
    ...
    if ip_address and last_modified:
        ...
        df.to_csv('data3_clean.csv', mode='a', header=False, index=False)

def main():
    file_path = r'F:\data\Graduate_Design\project_8099\clean_data\clean_data3\data3_phishing.csv'
