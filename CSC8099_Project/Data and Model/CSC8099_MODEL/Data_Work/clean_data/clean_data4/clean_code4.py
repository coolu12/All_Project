...
import os
#data source: Malicious And Benign URLs (link: https://www.kaggle.com/datasets/siddharthkumar25/malicious-and-benign-urls)
# 定义函数来解析URL并提取所需信息
def parse_url(url):
    try:
...
def list_run(new_data):
    ...
    if ip_address and last_modified:
        ...
        # 使用 mode='a' 并设置 header=False 以避免写入多次表头
        df.to_csv('data4_clean.csv', mode='a', header=False, index=False)

def main():
    file_path = r'F:\data\Graduate_Design\project_8099\clean_data\clean_data4\data4.csv'
